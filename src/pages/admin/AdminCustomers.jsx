...
const initialCustomers = [
  { id: 'c1', name: 'أحمد محمود حسن', phone: '01012345678', governorate: 'القاهرة', ordersCount: 5, totalSpent: 3850, lastOrder: '2026-09-14' },
  { id: 'c2', name: 'سارة عبد الله خالد', phone: '01198765432', governorate: 'الجيزة', ordersCount: 3, totalSpent: 2150, lastOrder: '2026-09-13' },
  { id: 'c3', name: 'محمد طارق فاروق', phone: '01234567890', governorate: 'الإسكندرية', ordersCount: 2, totalSpent: 2440, lastOrder: '2026-09-15' },
  { id: 'c4', name: 'منى إبراهيم السيد', phone: '01055566778', governorate: 'المنصورة', ordersCount: 7, totalSpent: 5900, lastOrder: '2026-09-10' },
  { id: 'c5', name: 'كريم الشناوي', phone: '01099887766', governorate: 'القاهرة', ordersCount: 4, totalSpent: 4100, lastOrder: '2026-09-12' },
  { id: 'c6', name: 'نورا سامي عثمان', phone: '01511223344', governorate: 'طنطا', ordersCount: 1, totalSpent: 850, lastOrder: '2026-09-08' }
];
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            سجل بيانات المشترين، عدد الطلبات، وإجمالي المشتريات
          </p>
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded-2xl border border-gray-200 shadow-xs">
        <div className="max-w-md relative">
          <input
            ...
            placeholder="بحث باسم العميل، الهاتف، أو المحافظة..."
